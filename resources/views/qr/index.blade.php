...
@section('container')
    ...
    <script>
        ...
        function generateQR() {
            ...
            if (!userData.name || !userData.email || !userData.nis || !userData.gender || !userData.classes_id || !userData
                .address) {
                Swal.fire({
                    icon: 'warning',
            ...
            if (userData.qr_status === "pending") {
                Swal.fire({
                    ...
                    text: 'Perubahan QR Code sedang menunggu persetujuan admin! Harap tunggu hingga disetujui sebelum mengajukan perubahan lagi.',
                });
                return;
            }
