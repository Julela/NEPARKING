      ...
      <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
        <div class="card investment-sec">
          ...
          <div class="card-body">
            ...
            <p>Masuk</p>
            <h3>{{ resolve(App\Models\ParkingA::class)->whereNotNull('waktu_masuk')->count() + resolve(App\Models\ParkingB::class)->whereNotNull('waktu_masuk')->count() }}</h3>
          </div>
        </div>
      </div>
      <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
        <div class="card investment-sec">
          ...
          <div class="card-body">
            ...
            <p>Riwayat</p>
            <h3>{{ resolve(\App\Models\ParkingA::class)->whereNotNull('waktu_keluar')->count() + resolve(\App\Models\ParkingB::class)->whereNotNull('waktu_keluar')->count() }}</h3>
          </div>
        </div>
      </div>
      <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
        <div class="card investment-sec">
          ...
          <div class="card-body">
            ...
            <p>Total Kendaraan</p>
            <h3>{{ resolve(App\Models\Kendaraan::class)->count() }}</h3>
          </div>
        </div>
      </div>
      <div class="col-xl-2 col-lg-4 col-sm-4 des-xsm-50 box-col-33">
