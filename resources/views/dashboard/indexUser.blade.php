                            ...
                            <div class="icon-box bg_color_5">
                                <svg width="25" height="25" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_4355_16445)">
                                        <path
                                            d="M12 2C8.13 2 5 5.13 5 9C5 13.25 10.55 20.16 11.27 21.08C11.64 21.53 12.36 21.53 12.73 21.08C13.45 20.16 19 13.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z"
                                            fill="#1E90FF" />
                                        <defs>
