        ...
        <div class="tf-balance-box">
            ...
            @if (Auth::check())
                <ul class="d-flex justify-content-between align-items-center">
                    ...
                    <li class="wallet-card-item"><a class="fw_6" style="text-align: center;" href="{{ url('/jadwal') }}">
                ...
                <ul class="d-flex justify-content-between align-items-center">
                    <li class="wallet-card-item">
                        <a href="{{ route('login') }}" class="fw_6 text-center">
                        <i class="fas fa-motorcycle fa-2x"  style="color: indigo;"></i> 
                        Kendaraan Saya
                        </a>
                    </li>
                    <li class="wallet-card-item"><a class="fw_6" style="text-align: center;" href="{{ route('login') }}">
                            <ul class="fas fa-chalkboard-teacher fa-2x" style="color: indigo;">
                                <li class="path1"></li>
                                <li class="path2"></li>
                                <li class="path3"></li>
                    ...
                    <li class="wallet-card-item"><a class="fw_6" href="{{ route('login') }}">
                            <ul class="fas fa-parking fa-2x" style="color: indigo;">
                                <li class="path1"></li>
                                <li class="path2"></li>
                                <li class="path3"></li>
