                        ...
                        <ul class="box-nav">
                                ...
                                <a href="{{ url('/cuti') }}" class="nav-link">
                                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="{{ Request::is('cuti*') ? 'blue' : 'black' }}" stroke-width="2" />
                                        <path d="M9 12H15" stroke="{{ Request::is('cuti*') ? 'blue' : 'black' }}" stroke-width="2" stroke-linecap="round" />
                                    </svg>
                            ...
                            <li>
                                <a href="{{ url('/kendaraan') }}" class="nav-link">
                                    ...
                                    <span style="{{ Request::is('kendaraan*') ? 'color: blue' : '' }}">Kendaraan</span>
                                </a>
                            </li>
                            <!-- <li>
