        ...
        <div class="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] max-w-6xl max-md:max-w-lg rounded-md p-6">
            ...
            <div class="grid md:grid-cols-2 items-center gap-8">
                <div class="max-md:order-1">
                    ...
                    <img src="{{ asset('img/loginpage.svg') }}" style="border-radius: 5px;" class="w-80 aspect-[12/11] object-contain"
                        alt="login-image" />
                </div> 
                ...
                <form class="md:max-w-md w-full mx-auto" method="POST" action="/login">
                    ...
                    <div class="mt-8">
                        <a href="/auth/google"> <button type="button"
                    ...
                    <div class="mt-12">
                        ...
                        <p class="text-gray-800 text-sm text-center mt-6">Belum mempunyai akun? <a href="/register"
