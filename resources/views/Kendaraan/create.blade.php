    ...
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('kendaraan.store') }}" method="POST" class="mt-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nomor_plat" class="w-full p-2 border border-gray-300 rounded-lg bg-gray-100"
                    value="{{ Auth::user()->qr_code }}" readonly>
            </div>


            <div class="mb-4">
                <label class="block text-gray-700">Merk</label>
                <input type="text" name="merk" class="w-full p-2 border border-gray-300 rounded-lg"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="model" class="w-full p-2 border border-gray-300 rounded-lg"
                    placeholder="Contoh: Vario 150, Supra X" required>
                @error('model')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            </div>
